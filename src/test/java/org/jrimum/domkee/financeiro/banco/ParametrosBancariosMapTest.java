...
public class ParametrosBancariosMapTest {
	...
	public void deve_conter_um_parametro_na_instanciacao_com_parametros() {
		...
		assertEquals(V1, parametrosBancariosMap.getValor(ParamBancTest.P1).intValue());
	...
	public void deve_indicar_que_tem_elementos_quando_o_map_passado_tem_mais_de_um_elementos() {
		ParametrosBancariosMap map = new ParametrosBancariosMap().adicione(ParamBancTest.P1, V1).adicione(ParamBancTest.P2, V2);
	...
	public void deve_retornar_um_valor_que_esteja_no_map() {
		ParametrosBancariosMap map = new ParametrosBancariosMap().adicione(ParamBancTest.P1, V1).adicione(ParamBancTest.P2, V2).adicione(ParamBancTest.P3, V3);
	...
	public void deve_retornar_null_quando_o_valor_nao_existe_no_map() {
		ParametrosBancariosMap map = new ParametrosBancariosMap().adicione(ParamBancTest.P1, V1).adicione(ParamBancTest.P3, V3);
	...
	public void deve_retornar_os_nomes_contidos_no_map() {
		...
		ParametrosBancariosMap map = new ParametrosBancariosMap().adicione(ParamBancTest.P1, V1).adicione(ParamBancTest.P2, V1).adicione(ParamBancTest.P3, V3);
	...
	public void deve_retornar_os_valores_contidos_no_map() {
		...
		ParametrosBancariosMap map = new ParametrosBancariosMap().adicione(ParamBancTest.P1, V1).adicione(ParamBancTest.P2, V2).adicione(ParamBancTest.P3, V3).adicione(ParamBancTest.P4, V4);
	...
	public void deve_retornar_o_conjunto_de_entradas_do_map() {
		ParametrosBancariosMap map = new ParametrosBancariosMap(ParamBancTest.P1, V1).adicione(ParamBancTest.P2, V2);
	...
	public void deve_adicionar_todos_os_parametros_de_um_outro_objeto_parametro_bancario_map_corretamente() {
		ParametrosBancariosMap mapA = new ParametrosBancariosMap().adicione(ParamBancTest.P1, V1).adicione(ParamBancTest.P2, V2);
		ParametrosBancariosMap mapB = new ParametrosBancariosMap().adicione(ParamBancTest.P3, V3).adicione(ParamBancTest.P4, V4);
